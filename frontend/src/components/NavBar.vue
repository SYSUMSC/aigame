...
<template>
  <div class="navbar">
    <nav class="bg-white shadow-md fixed w-full z-10 top-0 left-0">
      ...
      >
        <!-- Logo -->
        <RouterLink class="text-xl font-bold text-gray-800" to="/"
          >AI 竞赛平台</RouterLink
        >
        ...
        <div class="hidden lg:flex space-x-6">
          ...
          <template v-if="userStore.isLoggedIn()">
            <RouterLink
              class="text-gray-800 hover:text-blue-600"
              to="/info"
              @click="navigateAndCloseNav('/info')"
              >用户中心</RouterLink
            >
            <RouterLink
              class="text-gray-800 hover:text-blue-600"
          ...
          <template v-else>
            <RouterLink
              class="text-gray-800 hover:text-blue-600"
              to="/user/login"
              @click="navigateAndCloseNav('/user/login')"
              >登录</RouterLink
            >
            <RouterLink
              class="text-gray-800 hover:text-blue-600"
              to="/user/reg"
              @click="navigateAndCloseNav('/user/reg')"
              >注册</RouterLink
            >
          </template>
        </div>
